...
SemaphoreHandle_t dataAvailable = NULL;
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_INIT_EVT:
        if (param->init.status == ESP_SPP_SUCCESS) {
            ...
            esp_spp_start_srv(sec_mask, role_slave, 0, deviceName);
        } else {
    ...
    memcpy(bufferBTdata,param->data_ind.data,param->data_ind.len);
    bufferBTdata[param->data_ind.len]='\0';
